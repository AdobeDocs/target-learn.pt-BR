...
O uso das APIs de administrador do Target requer [Configuração de autenticação Adobe](https://experienceleague.adobe.com/docs/target-dev/developer/api/configure-authentication.html){target="_blank"}. Certifique-se de ter isso configurado antes de iniciar este tutorial.

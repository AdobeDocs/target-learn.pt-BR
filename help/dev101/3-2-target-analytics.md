...
description: Conheça os requisitos da implementação do Adobe Analytics com o Adobe Target (A4T).
...
Para obter mais informações, visite a [documentação](https://experienceleague.adobe.com/docs/target/using/integrate/a4t/a4timplementation.html?lang=pt-BR).
